...
public class JwtUtil {
    ...
    // Gera um token JWT com o nome de usuário e validade de 24 horas
    public String generateToken(String username) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000L * 60 * 60 * 24)) // Define a data e hora de expiração (24 horas a partir da emissão)
